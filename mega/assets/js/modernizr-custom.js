...
!(function (e, t, n) {
  ...
  function l(e, n, i, o) {
    ...
    if (parseInt(i, 10))
      for (; i--; )
        (d = s('div')), (d.id = o ? o[i] : u + (i + 1)), c.appendChild(d);
    return (
      (r = s('style')),
      (r.type = 'text/css'),
      (r.id = 's' + u),
      (p.fake ? p : c).appendChild(r),
      p.appendChild(c),
      r.styleSheet
  ...
  function h(e, t, o, r) {
    ...
    for (
      var u, c, p, h, g, v = ['modernizr', 'tspan', 'samp'];
      !A.style && v.length;

    )
      (u = !0), (A.modElem = s(v.shift())), (A.style = A.modElem.style);
  ...
  (x._prefixes = T),
    Modernizr.addTest('cssgradients', function () {
      for (
        ...
        (e = 0 === o ? 'to ' : ''),
          (i += t + T[o] + 'linear-gradient(' + e + 'left top, #9f9, white);');
  ...
  Modernizr.inputtypes = (function (e) {
    for (var i, o, r, s = e.length, a = '1)', l = 0; s > l; l++)
      C.setAttribute('type', (i = e[l])),
        (r = 'text' !== C.type && 'style' in C),
        r &&
          ((C.value = a),
          ...
          /^range$/.test(i) && C.style.WebkitAppearance !== n
            ? (w.appendChild(C),
              ...
              (r =
                o.getComputedStyle &&
                'textfield' !== o.getComputedStyle(C, null).WebkitAppearance &&
                0 !== C.offsetHeight),
              w.removeChild(C))
            : /^(search|tel)$/.test(i) ||
              (r = /^(url|email)$/.test(i)
                ? C.checkValidity && C.checkValidity() === !1
                : C.value != a)),
        (z[e[l]] = !!r);
    return z;
  })(k);
